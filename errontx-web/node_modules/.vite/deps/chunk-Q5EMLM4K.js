...
function useUniqueMemo(memoFn, deps) {
  return import_react3.default.useMemo(function() {
...
function genStyleUtils(config) {
  ...
  function genCSSVarRegister(component, getDefaultToken, options) {
    ...
    var useCSSVar = function useCSSVar2(rootCls) {
      ...
      return [function(node2) {
        return injectStyle && cssVar ? import_react4.default.createElement(import_react4.default.Fragment, null, import_react4.default.createElement(CSSVarRegister, {
          rootCls,
          cssVar,
          component
        }), node2) : node2;
...
function useComponentConfig(propName) {
  const context = React13.useContext(ConfigContext);
  const {
    getPrefixCls,
    direction,
    getPopupContainer
...
//# sourceMappingURL=chunk-Q5EMLM4K.js.map
